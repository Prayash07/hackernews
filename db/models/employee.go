...
type Employee struct {
	...
	Salary null.Int `boil:"salary" json:"salary,omitempty" toml:"salary" yaml:"salary,omitempty"`
...
var EmployeeWhere = struct {
	ID     whereHelperint
	Salary whereHelpernull_Int
	UserID whereHelpernull_Int
}{
	ID:     whereHelperint{field: "`employee`.`id`"},
	Salary: whereHelpernull_Int{field: "`employee`.`salary`"},
	UserID: whereHelpernull_Int{field: "`employee`.`user_id`"},
}
...
var (
	employeeAllColumns            = []string{"id", "salary", "user_id"}
	employeeColumnsWithoutDefault = []string{"salary", "user_id"}
...
func FindEmployeeG(ctx context.Context, iD int, selectCols ...string) (*Employee, error) {
...
func (o *Employee) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to populate default values for employee")
	}
...
func (o *Employee) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert for employee")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to retrieve unique values for employee")
	}
...
func EmployeeExistsG(ctx context.Context, iD int) (bool, error) {
